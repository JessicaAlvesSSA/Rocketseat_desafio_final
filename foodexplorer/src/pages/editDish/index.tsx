...
export function EditDish() {
  return (
    <main className="edit-dish container" style={{ minHeight: window.innerHeight - 191 }}>
      ...
      <form action="PUT">
        ...
        <div className="buttons">
          <button className="secundary">Excluir prato</button>
          <button className="primary-light">Salvar alterações</button>
        </div>
      </form>
    </main>
  );
